...
| [P-051](../principles/P-051-remote-call-resilience.md) | Every remote call has a timeout, a retry policy, and a bulkhead | `ResilienceRules.remoteCallsDeclareTimeouts` | `OrderEventPublisherAdapter`, `ResilienceRules` |
...
| [P-072](../principles/P-072-transactional-outbox.md) | State changes and their events commit together | `OutboxRules.noBrokerCallInsideATransaction` | `OrderEventPublisherAdapter` |
