...
| [P-033](P-033-workflow-definitions-are-deterministic.md) | Workflow definitions are deterministic, and call the world only through an activity | application | `WorkflowRules.workflowDefinitionsStayFrameworkFree()` | [temporal](../../.claude/skills/temporal/SKILL.md) |
...
| [P-044](P-044-object-storage-presigned-access.md) | Object storage is reached through the S3 API, and access is presigned, never proxied | adapter | `BlobStorageRules.presignedUrlsGoThroughTheSanctionedFactory()` | [blob-storage](../../.claude/skills/blob-storage/SKILL.md) |
...
| [P-132](P-132-scheduled-jobs.md) | A scheduled job is exclusive across instances by construction, never by convention | adapter | `SchedulingRules.schedulerAdaptersAreClusterSafe()` | [scheduling](../../.claude/skills/scheduling/SKILL.md) |
