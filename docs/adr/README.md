...
| [0021](0021-keycloak-sso-and-opa-as-the-standard-authorization-sidecar.md) | Keycloak for platform SSO; OPA as the standard authorization sidecar | Accepted | 2026-09-02 | — |
| [0022](0022-distributed-caches-are-bounded-by-the-module-not-the-caller.md) | A distributed cache's timeout and failure policy belong to caching-support, not to each caller | Accepted | 2026-09-02 | — |
